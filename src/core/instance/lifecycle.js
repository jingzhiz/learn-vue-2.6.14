...
/*
  # callHook(vm, 'mounted')
  # 执行实例指定的生命周期钩子函数
  # 如果实例设置有对应的 Hook Event
  # 比如：<comp @hook:mounted="method" />，执行完生命周期函数之后，触发该事件的执行
*/
export function callHook(vm: Component, hook: string) {
  ...
  /*
    # HookEvent，如果设置了 HookEvent，则 vm._hasHookEvent = true;
    # 比如 <comp @hook:mounted="method" />，则通过 $emit 触发该事件
  */
  if (vm._hasHookEvent) {
    vm.$emit("hook:" + hook);
  }
